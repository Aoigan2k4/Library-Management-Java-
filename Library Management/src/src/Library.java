...
public class Library {
    ...
    int count = 0;
    public void Start() {
        Book book1 = new Book.Builder("001", "Design")
                .author("Joshua")
                .isAvailable(true)
                .build();

        Book book2 = new Book.Builder("002", "Amazing Java")
                .author("Goetz")
                .isAvailable(true)
                .build();

        Book book3 = new Book.Builder("003", "React")
                .author("Martin")
                .isAvailable(true)
                .build();

        Book book4 = new Book.Builder("004", "Advanced OOP")
                .author("Septim")
                .isAvailable(true)
                .build();
        if (count == 0) {
            ...
            try {
                ...
                switch (choice) {
                    ...
                    do {
                        ...
                        val.LogIn(username, password, acc);
                                            ...
                                            switch (choice2) {
                                                case 1 -> {
                                                    ...
                                                    if (foundBook1 != null) {
                                                        ...
                                                        System.out.println("Do you want to (1) Borrow or (2) Return this book?");
                                                        ...
                                                        switch (action) {
                                                            case 1 -> {
                                                                if (repository.getBookStock(foundBook1.getIsbn()) == 0)
                                                                {
                                                                    ...
                                                                    System.out.println("The boos is currently unavailable! Come back later!");
                                                                }
                                                                else {
